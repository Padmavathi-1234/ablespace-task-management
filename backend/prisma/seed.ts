...
async function main() {
  ...
  // 1. Create Main User (Dexter from Figma)
  ...
  // 4. Create Labels (matching Figma tags)
  ...
  // 6. Create Tasks (matching Figma Board)

  // Task 1: Write API Documentation (Detail page task in Figma)
