            ...
            <>
              ...
              <div className="absolute right-0 mt-1 w-36 bg-white dark:bg-neutral-900 rounded-xl shadow-lg border border-gray-200 dark:border-neutral-800 py-1 z-20 text-left">
                <button
                  ...
                  className="w-full px-3 py-1.5 text-xs text-gray-700 dark:text-neutral-300 hover:bg-gray-100 dark:hover:bg-neutral-800 flex items-center gap-2 transition-colors"
                >
                ...
                <button
                  ...
                  className="w-full px-3 py-1.5 text-xs text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/50 flex items-center gap-2 transition-colors"
                >
